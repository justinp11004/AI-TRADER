...
| Q5 (×6 rewrites) · V1 | Chart Studio + Vision Desk multi-TF | **RESEARCH → Chart** (TF ladder, chart types, EMA20/50/VWAP, detector-cited zones, deterministic replay scrubber, 8-TF vision wall with per-TF machine reads, TA-notes .md download) |
